...
class PanoramaObserver(_object):
    ...
    def panoramaChanged(self, *args):
        """panoramaChanged(PanoramaObserver self, PanoramaData pano)"""
        return _hsi.PanoramaObserver_panoramaChanged(self, *args)

    def panoramaImagesChanged(self, *args):
        """panoramaImagesChanged(PanoramaObserver self, PanoramaData pano, HuginBase::UIntSet const & changed)"""
...
class PanoramaOptions(_object):
    ...
    if _newclass:outfile = _swig_property(_hsi.PanoramaOptions_outfile_get, _hsi.PanoramaOptions_outfile_set)
    ...
    if _newclass:colorCorrection = _swig_property(_hsi.PanoramaOptions_colorCorrection_get, _hsi.PanoramaOptions_colorCorrection_set)
    ...
    if _newclass:gamma = _swig_property(_hsi.PanoramaOptions_gamma_get, _hsi.PanoramaOptions_gamma_set)
    ...
    if _newclass:remapAcceleration = _swig_property(_hsi.PanoramaOptions_remapAcceleration_get, _hsi.PanoramaOptions_remapAcceleration_set)
    ...
    if _newclass:photometricSymmetricError = _swig_property(_hsi.PanoramaOptions_photometricSymmetricError_get, _hsi.PanoramaOptions_photometricSymmetricError_set)
...
class SrcPanoImage(BaseSrcPanoImage):
    ...
    def __init__(self, *args): 
        ...
        __init__(HuginBase::SrcPanoImage self, std::string const & filename) -> SrcPanoImage
        """
        this = _hsi.new_SrcPanoImage(*args)
        try: self.this.append(this)
        except: self.this = this
    def hasEXIFread(self):
        """hasEXIFread(SrcPanoImage self) -> bool const"""
        return _hsi.SrcPanoImage_hasEXIFread(self)
    ...
    def readEXIF(self, *args):
        """
        readEXIF(SrcPanoImage self, double & focalLength, double & cropFactor, bool applyEXIF, bool applyExposureValue) -> bool
        readEXIF(SrcPanoImage self, double & focalLength, double & cropFactor, double & eV, bool applyEXIF, bool applyExposureValue) -> bool
        """
        return _hsi.SrcPanoImage_readEXIF(self, *args)
...
class ControlPoint(_object):
    ...
    def getModeName(self, *args):
        ...
        return _hsi.ControlPoint_getModeName(self, *args)
...
class Lens(_object):
    ...
    def setEV(self, *args):
        ...
        return _hsi.Lens_setEV(self, *args)
...
class AlignInfoWrap(_object):
    """Proxy of C++ HuginBase::PTools::AlignInfoWrap class"""
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AlignInfoWrap, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AlignInfoWrap, name)
    __repr__ = _swig_repr
    def __init__(self): 
        """__init__(HuginBase::PTools::AlignInfoWrap self) -> AlignInfoWrap"""
        this = _hsi.new_AlignInfoWrap()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _hsi.delete_AlignInfoWrap
    __del__ = lambda self : None;
    def setInfo(self, *args):
        """setInfo(AlignInfoWrap self, PanoramaData pano) -> bool"""
        return _hsi.AlignInfoWrap_setInfo(self, *args)

    def setGlobal(self):
        """setGlobal(AlignInfoWrap self)"""
        return _hsi.AlignInfoWrap_setGlobal(self)

    def getVariables(self):
        """getVariables(AlignInfoWrap self) -> HuginBase::VariableMapVector"""
        return _hsi.AlignInfoWrap_getVariables(self)

    def getCtrlPoints(self):
        """getCtrlPoints(AlignInfoWrap self) -> HuginBase::CPVector"""
        return _hsi.AlignInfoWrap_getCtrlPoints(self)

AlignInfoWrap_swigregister = _hsi.AlignInfoWrap_swigregister
AlignInfoWrap_swigregister(AlignInfoWrap)
...
def createAdjustPrefs(*args):
  """createAdjustPrefs(aPrefs & p, TrformStr & transf)"""
  return _hsi.createAdjustPrefs(*args)

def setAdjustSrcImg(*args):
  """
    setAdjustSrcImg(TrformStr & trf, aPrefs & ap, int width, int height, unsigned char * imageData, HuginBase::VariableMap const & vars, 
        HuginBase::Lens::LensProjectionFormat const format, 
        bool correctDistortions)
    """
  return _hsi.setAdjustSrcImg(*args)

def setAdjustDestImg(*args):
  """setAdjustDestImg(TrformStr & trf, aPrefs & ap, int width, int height, unsigned char * imageData, PanoramaOptions opts)"""
  return _hsi.setAdjustDestImg(*args)

def createAdjustTrform(*args):
  """createAdjustTrform(TrformStr & trf)"""
  return _hsi.createAdjustTrform(*args)

def freeTrform(*args):
  """freeTrform(TrformStr & trf)"""
  return _hsi.freeTrform(*args)
...
def setOptVars(*args):
  """setOptVars(optVars & opt, std::set< std::string,std::less< std::string >,std::allocator< std::string > > const & optvars)"""
  return _hsi.setOptVars(*args)
...
class AssistantMakefilelibExport(PanoramaAlgorithm):
    ...
    __swig_setmethods__ = {}
    for _s in [PanoramaAlgorithm]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, AssistantMakefilelibExport, name, value)
    __swig_getmethods__ = {}
    for _s in [PanoramaAlgorithm]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, AssistantMakefilelibExport, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(HuginBase::AssistantMakefilelibExport self, PanoramaData pano_, HuginBase::AssistantMakefilelibExport::AssistantPrograms const & progs_, 
            bool const & runLinefind_, bool const & runCeleste_, double const & celesteThreshold_, 
            bool const & celesteSmallRadius_, bool const & runCPClean_, 
            double const & scale_, ostream makefile_, std::string const & projectFile_) -> AssistantMakefilelibExport
        """
        this = _hsi.new_AssistantMakefilelibExport(*args)
        try: self.this.append(this)
        except: self.this = this
    def createMakefile(*args):
        """
        createMakefile(PanoramaData pano_, HuginBase::AssistantMakefilelibExport::AssistantPrograms const & progs_, 
            bool const & runLinefind_, bool const & runCeleste_, double const & celesteThreshold_, 
            bool const & celesteSmallRadius_, bool const & runCPClean_, 
            double const & scale_, ostream makefile_, std::string const & projectFile_)
        """
        return _hsi.AssistantMakefilelibExport_createMakefile(*args)

    if _newclass:createMakefile = staticmethod(createMakefile)
    __swig_getmethods__["createMakefile"] = lambda x: createMakefile
    def modifiesPanoramaData(self):
        """modifiesPanoramaData(AssistantMakefilelibExport self) -> bool"""
        return _hsi.AssistantMakefilelibExport_modifiesPanoramaData(self)

    def runAlgorithm(self):
        """runAlgorithm(AssistantMakefilelibExport self) -> bool"""
        return _hsi.AssistantMakefilelibExport_runAlgorithm(self)

    __swig_destroy__ = _hsi.delete_AssistantMakefilelibExport
    __del__ = lambda self : None;
AssistantMakefilelibExport_swigregister = _hsi.AssistantMakefilelibExport_swigregister
AssistantMakefilelibExport_swigregister(AssistantMakefilelibExport)

def AssistantMakefilelibExport_createMakefile(*args):
  """
    AssistantMakefilelibExport_createMakefile(PanoramaData pano_, HuginBase::AssistantMakefilelibExport::AssistantPrograms const & progs_, 
        bool const & runLinefind_, bool const & runCeleste_, double const & celesteThreshold_, 
        bool const & celesteSmallRadius_, bool const & runCPClean_, 
        double const & scale_, ostream makefile_, std::string const & projectFile_)
    """
...
class CalculateOptimalROI(PanoramaAlgorithm):
    ...
    def __init__(self, *args): 
        """
        __init__(HuginBase::CalculateOptimalROI self, PanoramaData panorama, bool intersect=False) -> CalculateOptimalROI
        __init__(HuginBase::CalculateOptimalROI self, PanoramaData panorama) -> CalculateOptimalROI
        __init__(HuginBase::CalculateOptimalROI self, PanoramaData panorama, std::vector< HuginBase::UIntSet,std::allocator< HuginBase::UIntSet > > hdr_stacks) -> CalculateOptimalROI
        """
    ...
    def calcOptimalROI(self, *args):
        """calcOptimalROI(CalculateOptimalROI self, PanoramaData panorama) -> bool"""
        return _hsi.CalculateOptimalROI_calcOptimalROI(self, *args)
...
def getHDRStacks(*args):
  """getHDRStacks(PanoramaData pano, HuginBase::UIntSet allImgs, PanoramaOptions opts) -> std::vector< HuginBase::UIntSet,std::allocator< HuginBase::UIntSet > >"""
  return _hsi.getHDRStacks(*args)

def getExposureLayers(*args):
  """getExposureLayers(PanoramaData pano, HuginBase::UIntSet allImgs, PanoramaOptions opts) -> std::vector< HuginBase::UIntSet,std::allocator< HuginBase::UIntSet > >"""
...
def getCPoutsideLimit_pair(*args):
  """
    getCPoutsideLimit_pair(Panorama pano, double n=2.0) -> HuginBase::UIntSet
    getCPoutsideLimit_pair(Panorama pano) -> HuginBase::UIntSet
    """
...
class NonaFileOutputStitcher(FileOutputStitcherAlgorithm):
    ...
    def __init__(self, *args): 
        ...
        __init__(HuginBase::NonaFileOutputStitcher self, PanoramaData panoramaData, AppBase::ProgressDisplay * progressDisplay, PanoramaOptions options, 
            HuginBase::UIntSet const & usedImages, HuginBase::FileOutputStitcherAlgorithm::String const & filename) -> NonaFileOutputStitcher
        """
...
class PhotometricOptimizer(TimeConsumingPanoramaAlgorithm):
    ...
    def __init__(self, *args): 
        ...
        __init__(HuginBase::PhotometricOptimizer self, PanoramaData panorama, AppBase::ProgressDisplay * progressDisplay, OptimizeVector vars, 
            HuginBase::PhotometricOptimizer::PointPairs const & correspondences) -> PhotometricOptimizer
        """
    ...
    def optimizePhotometric(*args):
        ...
        optimizePhotometric(PanoramaData pano, OptimizeVector vars, HuginBase::PhotometricOptimizer::PointPairs const & correspondences, 
            AppBase::ProgressReporter & progress, double & error)
        """
...
class SmartPhotometricOptimizer(PhotometricOptimizer):
    ...
    def __init__(self, *args): 
        ...
        __init__(HuginBase::SmartPhotometricOptimizer self, PanoramaData panorama, AppBase::ProgressDisplay * progressDisplay, OptimizeVector vars, 
            ...
            HuginBase::SmartPhotometricOptimizer::PhotometricOptimizeMode optMode) -> SmartPhotometricOptimizer
        """
...
class PanoramaMakefilelibExport(PanoramaAlgorithm):
    ...
    __swig_setmethods__ = {}
    for _s in [PanoramaAlgorithm]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, PanoramaMakefilelibExport, name, value)
    __swig_getmethods__ = {}
    for _s in [PanoramaAlgorithm]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, PanoramaMakefilelibExport, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(HuginBase::PanoramaMakefilelibExport self, PanoramaData pano_, HuginBase::UIntSet const & images_, std::string const & ptofile_, 
            std::string const & outputPrefix_, HuginBase::PanoramaMakefilelibExport::PTPrograms const & progs_, 
            std::string const & includePath_, std::vector< std::string,std::allocator< std::string > > & outputFiles_, 
            ostream makefile_, 
            std::string const & tmpDir_, bool const copyMetadata_, int const nrThreads_) -> PanoramaMakefilelibExport
        """
        this = _hsi.new_PanoramaMakefilelibExport(*args)
        try: self.this.append(this)
        except: self.this = this
    def createMakefile(*args):
        """
        createMakefile(PanoramaData pano_, HuginBase::UIntSet const & images_, std::string const & ptofile_, 
            std::string const & outputPrefix_, HuginBase::PanoramaMakefilelibExport::PTPrograms const & progs_, 
            std::string const & includePath_, std::vector< std::string,std::allocator< std::string > > & outputFiles_, 
            ostream makefile_, 
            std::string const & tmpDir_, bool const copyMetadata_, int const nrThreads_)
        """
        return _hsi.PanoramaMakefilelibExport_createMakefile(*args)

    if _newclass:createMakefile = staticmethod(createMakefile)
    __swig_getmethods__["createMakefile"] = lambda x: createMakefile
    def modifiesPanoramaData(self):
        """modifiesPanoramaData(PanoramaMakefilelibExport self) -> bool"""
        return _hsi.PanoramaMakefilelibExport_modifiesPanoramaData(self)

    def runAlgorithm(self):
        """runAlgorithm(PanoramaMakefilelibExport self) -> bool"""
        return _hsi.PanoramaMakefilelibExport_runAlgorithm(self)

    __swig_destroy__ = _hsi.delete_PanoramaMakefilelibExport
    __del__ = lambda self : None;
PanoramaMakefilelibExport_swigregister = _hsi.PanoramaMakefilelibExport_swigregister
PanoramaMakefilelibExport_swigregister(PanoramaMakefilelibExport)

def PanoramaMakefilelibExport_createMakefile(*args):
  """
    PanoramaMakefilelibExport_createMakefile(PanoramaData pano_, HuginBase::UIntSet const & images_, std::string const & ptofile_, 
        std::string const & outputPrefix_, HuginBase::PanoramaMakefilelibExport::PTPrograms const & progs_, 
        std::string const & includePath_, std::vector< std::string,std::allocator< std::string > > & outputFiles_, 
        ostream makefile_, 
        std::string const & tmpDir_, bool const copyMetadata_, int const nrThreads_)
...
def printstacks(*args):
  """printstacks(std::vector< HuginBase::UIntSet,std::allocator< HuginBase::UIntSet > > const & stackdata)"""
  return _hsi.printstacks(*args)
class PointSampler(TimeConsumingPanoramaAlgorithm):
    ...
    __del__ = lambda self : None;
    def extractPoints(*args):
        """
        extractPoints(PanoramaData pano, std::vector< vigra::FRGBImage *,std::allocator< vigra::FRGBImage * > > images, 
            int nPoints, bool randomPoints, AppBase::ProgressReporter & progress, 
            std::vector< vigra_ext::PointPairRGB,std::allocator< vigra_ext::PointPairRGB > > & points)
        """
        return _hsi.PointSampler_extractPoints(*args)

    if _newclass:extractPoints = staticmethod(extractPoints)
...
def PointSampler_extractPoints(*args):
  """
    PointSampler_extractPoints(PanoramaData pano, std::vector< vigra::FRGBImage *,std::allocator< vigra::FRGBImage * > > images, 
        int nPoints, bool randomPoints, AppBase::ProgressReporter & progress, 
        std::vector< vigra_ext::PointPairRGB,std::allocator< vigra_ext::PointPairRGB > > & points)
    """
  return _hsi.PointSampler_extractPoints(*args)
