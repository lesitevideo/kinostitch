...
for (( i=1; i<=nd; i++ )); do
	...
	echo $stitchto
		...
		#enblend --compression=jpeg -o stitched.jpg -- stitched0000.png stitched0001.png stitched0002.png stitched0003.png
		#enblend -o stitched.png -- stitched0000.png stitched0001.png stitched0002.png stitched0003.png
